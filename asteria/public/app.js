...
function switchSection(name) {
  ...
  if (name === 'profile' && previous !== 'profile') state.profileReturnSection = previous || 'chats';
  state.activeSection = name;
  ['chats', 'calls', 'settings', 'admin', 'profile'].forEach((s) => {
...
$('#profileBackBtn').addEventListener('click', () => switchSection(state.profileReturnSection || 'chats'));
